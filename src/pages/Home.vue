  ...
  <div class="home">
    <h3 class="title">
      ...
      <small class="subtitle">
        ...
        <a href="https://github.com/doug-gainey/magic-resume-generator/fork" target="_blank">Fork Magic Resume Generator on Github</a>
      </small>
    </h3>
    <div class="previews">
      <div v-for="template in templates" :key="template" class="preview">
        <router-link :to="'/resume/' + template">
          <div class="preview-wrapper">
            <img :src="'/assets/previews/resume-' + template + '.png'" alt="" />
            <span>{{ template }}</span>
          </div>
        </router-link>
      </div>
